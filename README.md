...
- iPad 0.24.7 (build 40) 增加 GP 区间越界的播放时钟兜底回绕，并修复 PDF 控制层恢复按钮命中；保留 0.24.6 的 600 ms 长按、8 点移动容差、文件库自动刷新、视频时间单行显示及节拍细分中文紧凑布局；等待覆盖安装并按 `docs/IPAD_MINI6_ACCEPTANCE.md` 真机验收。
