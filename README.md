...
- iPad 0.24.8 (build 41) 修复 GP 从循环段外恢复时谱面未立即跟随循环起点；保留 0.24.7 的区间越界回绕和 PDF 控制层命中，以及 600 ms 长按、8 点移动容差、文件库自动刷新、视频时间单行显示及节拍细分中文紧凑布局；等待覆盖安装并按 `docs/IPAD_MINI6_ACCEPTANCE.md` 真机验收。
